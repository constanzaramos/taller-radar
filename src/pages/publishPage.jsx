    ...
    <div className="min-h-screen bg-[#FFF7F0] flex flex-col">
      ...
      <main className="flex-1">
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 xl:gap-16 items-stretch">
            {/* Narrativa principal */}
            <div className="relative flex flex-col gap-8 h-full">
              ...
              <div className="relative mt-4 flex-1 flex items-end">
                ...
                <img
                  ...
                  className="relative w-full max-w-[520px] lg:max-w-none lg:h-full object-cover rounded-lg "
                />
              </div>
            </div>

            {/* Formulario */}
            <div id="form" className="w-full flex justify-center lg:justify-end items-stretch">
              <WorkshopForm />
            </div>
          </div>
        </section>
